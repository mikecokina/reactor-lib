...
class GFPGANModel(BaseModel):
    ...
    def construct_img_pyramid(self):
        ...
        for _ in range(0, self.log_size - 3):
            down_img = func.interpolate(down_img, scale_factor=0.5, mode='bilinear', align_corners=False)
    ...
    def gray_resize_for_identity(self, out, size=128):
        ...
        out_gray = func.interpolate(out_gray, (size, size), mode='bilinear', align_corners=False)
        return out_gray
